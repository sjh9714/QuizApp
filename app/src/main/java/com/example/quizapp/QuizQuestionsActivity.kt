...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setQuestion() {
        ...
        tv_option_1.text = question.option_1
        tv_option_2.text = question.option_2
        tv_option_3.text = question.option_3
        tv_option_4.text = question.option_4
    }
